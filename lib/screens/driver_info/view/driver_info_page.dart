...
class DriverInfoPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('driver_info'.tr, style: const TextStyle(color: Colors.white, fontSize: 16),),
        leading: InkWell(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: InputCard(
                    child: Column(
                      children: [
                        Image.asset('asset/car_icon/car_info.png', height: 200, width: 300.w,),
                ...
                DateInputField(title: "Date", controller: controller.dateController, onClick: ()=>controller.selectDate(context),),
                SizedBox(height: 12.h),
                CustomFromFiled(title: "Driver's Full Name", controller: controller.driverNameController,),
                SizedBox(height: 12.h),
                CustomFromFiled(title: "Vehicle Make and Model", controller: controller.vehicleModelController ,),
                SizedBox(height: 12.h),
                VehicleInspectionRadioTheme(
                  isDamage: controller.isDamage.value,
                  isWashed: controller.isWashed.value,
                  onDamageChanged: (value) => controller.isDamage.value = value ?? false,
                  onWashedChanged: (value) => controller.isWashed.value = value ?? false,
                ),
                SizedBox(height: 12.h),
                DriverDeclarationContent(
                    isDeclare: controller.isDeclare.value,
                    onDeclareChanged: (value) => controller.isDeclare.value = value
                ),
                SizedBox(height: 12.h),
                PictureContent(selectedImages: controller.selectedImages,),
                SizedBox(height: 12.h),
                SignatureContent(
