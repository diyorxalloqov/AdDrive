...
//
//     final responseLocation = responseLocationFromJson(jsonString);

import 'dart:convert';

BariKoiLocationModel responseLocationFromJson(json) => BariKoiLocationModel.fromJson(json);

String responseLocationToJson(BariKoiLocationModel data) => json.encode(data.toJson());

class BariKoiLocationModel {
  BariKoiLocationModel({
    this.place,
    this.status,
  });
  ...
  factory BariKoiLocationModel.fromJson(Map<String, dynamic> json) => BariKoiLocationModel(
